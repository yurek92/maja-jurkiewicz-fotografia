...
<div class="min-h-screen bg-green-800 sm:p-4 sm:p-12 flex items-center justify-center">
    <div class="sm:grid sm:grid-cols-3 sm:gap-4 items-center bg-white shadow sm:rounded-lg p-4">
        <div class="flex justify-center">
            <img class="h-24 sm:h-32" src="public/logo.png">
        </div>
        <div class="text-2xl sm:text-4xl text-green-700 text-center font-medium mt-3 sm:mt-0 col-span-2">
            Wasz formularz został poprawnie wysłany!<br>
